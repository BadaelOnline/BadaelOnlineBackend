...
<form action="{{ route('admin.testi.update',$testi->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <div class="form-group ml-4">
            ...
            <label for="status" class="col-sm-2 col-form-label">{{ __('testi.status') }}</label>
        ...
        <div class="form-group ml-4">
            ...
            <div class="col-sm-3">
                ...
                <button type="submit" class="btn btn-primary">{{ __('testi.update') }}</button>
