    ...
    <div class="form-group m-4">
        ...
        <div class="form-group ml-3 col-sm-7">
            <div class="rowInput">
                ...
                <div class="en col-sm-9">
                    ...
                    <input type="text" name='links[en][name]' class="form-control {{$errors->first('name') ? "is-invalid" : "" }} " value="{{old('name')}}" id="name">
                ...
                <div class="ar col-sm-9">
                    ...
                    <input type="text" name='links[ar][name]' class="form-control {{$errors->first('name') ? "is-invalid" : "" }} " value="{{old('name')}}" id="name">
        ...
        <div class="form-group ml-4">
            ...
            <div class="col-sm-3">
                ...
                <button type="submit" class="btn btn-primary">{{ __('link.create') }}</button>
