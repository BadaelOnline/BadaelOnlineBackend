        ...
        <div class="form-group ml-3 col-sm-7">
            <div class="rowInput">
                ...
                <div class="en col-sm-9">
                    ...
                    <input type="text" name='page[en][title]' class="form-control {{$errors->first('title') ? "is-invalid" : "" }} " value="{{old('title') ? old('title') : $page->title}}" id="title">
                ...
                <div class="ar col-sm-9">
                    ...
                    <input type="text" name='page[ar][title]' class="form-control {{$errors->first('title') ? "is-invalid" : "" }} " value="{{old('title') ? old('title') : $page->title}}" id="title">
